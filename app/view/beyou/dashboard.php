...
<div class="content">
  <div class="container-fluid">
    <?php
      include("../app/model/m_dashboard.php");
      echo generateTeamTable($_SESSION["entity"]);
    ?>
    ...
    <div class="card card-primary card-outline card-outline-tabs">
      <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">Graphs</a>
          </li>
          <li class="nav-item">
